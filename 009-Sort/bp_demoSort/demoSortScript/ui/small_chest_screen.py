...
class SmallChestScreen(ChestSortBaseScreen):
    """
    ChestSort
    """
    ...
    def __init__(self, namespace, name):
        ...
        print '==== %s ====' % 'init SmallChestScreen'
        self.bindParent = "variables_button_mappings_and_controls/safezone_screen_matrix/inner_matrix/safezone_screen_panel/root_screen_panel/root_panel/chest_panel/small_chest_panel_top_half/chest_label"

    def OnCreate(self):
        ChestSortBaseScreen.OnCreate(self)
        print '==== %s ====' % 'SmallChestScreen Create'
        self.LoadSortButton()
