...
import demoMinimapScript.ui.uiDef as uiDef
from demoMinimapScript.minimapConst import ModName
...
class UIMgr(object):
    ...
    def InitSingleUI(self, uiKey, config):
        ...
        if config.get("version", 1) == 1:
            extraParam = config.get("extraParam", {})
    ...
    def PushScreen(self, uiKey, params=None):
        return extraClientApi.PushScreen(ModName, uiKey, params)
